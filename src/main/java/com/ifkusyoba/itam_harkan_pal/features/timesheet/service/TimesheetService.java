...
public class TimesheetService {
    ...
    public Page<GetTimesheetResponse> getAllTimesheet(int page, int size) {
        Page<Timesheet> timesheets = timesheetRepository.findAll(PageRequest.of(page, size));

        return timesheets.map(timesheet -> GetTimesheetResponse.builder()
